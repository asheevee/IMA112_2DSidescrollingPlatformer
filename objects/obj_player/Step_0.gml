...
var l42678B7C_0 = instance_place(x + 0, y + 48, [obj_floor1]);
if ((l42678B7C_0 > 0))
{
...
else
{
	...
	/// @DnDHash : 3D7A6460
	/// @DnDParent : 3A250E90
	/// @DnDArgument : "expr" "move_jumpTimer <= 24"
	if(move_jumpTimer <= 24)
	{
		/// @DnDAction : YoYo Games.Common.Variable
		/// @DnDVersion : 1
		/// @DnDHash : 3DAB2ABF
...
/// @DnDArgument : "expr" "move_isJumping and move_jumpTimer > 24"
if(move_isJumping and move_jumpTimer > 24)
{
	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
	/// @DnDHash : 311CA547
